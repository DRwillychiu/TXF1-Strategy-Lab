...
- **Rule #18 5 件套 (v1.4)：3/5** — Stress/Regime/Robustness PASS；MC (95% MDD 39%) 與 Bootstrap (P(Net≤0)=2.9%) FAIL，共同根源 = B1 alpha 集中。詳見 [`S16_S_v14_fivepiece_20260718.md`](../research/S16_MACrossShort/S16_S_v14_fivepiece_20260718.md)
- **身分修正**：alpha 全在 Volatile regime (89T, PF 2.02)；Bear 僅 3 筆 —「崩盤/波動收割者」非「熊市策略」。風險告知：真實 95% DD 潛力 ≈ -390K（配置資本須承受）
