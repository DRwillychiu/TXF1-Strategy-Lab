...
**Version**: v1.5 | **Cap**: 3% | **Deployed**: 2026-07-10 (合規 07-16 / 護欄+保本延後 07-18 / 停損硬化 07-26)
...
## Core Metrics（5.6 年 backtest，數據至 2026-07-26，v1.5 baseline）

| 指標 | v1.5 (現行) | vs v1.4 |
|------|------------|---------|
| Net | **+2,006,800 NTD** | +933,600 (+87%) |
| PF | **1.775** | -0.10 |
| MDD | **-456,000 (-18.3%)** | MDD% 持平 |
| WR | 25.89% | -0.7pp |
| Win:Loss | **5.08 : 1** | — |
| Sharpe (年化) | **+0.718** | +0.15 |
| Sortino | **1.216** | +0.24 |
...
> v1.5 (2026-07-26): SetStopContract bug fix + SL_Pct=1.00 + engine stop 架構修正。
> Net +87% 來自消除跨 regime 過時 ATR 停損（結構性缺陷修正，非參數優化）。
> MDD 絕對值翻倍但 MDD% 持平（18.6%→18.3%）= 風險不變。
> G-tracks 全記錄見 [`S16_S_OPEN_ISSUES_20260713.md`](../research/S16_MACrossShort/S16_S_OPEN_ISSUES_20260713.md)

---

## Alpha 結構（v1.5 Excel 交叉驗證）

| 出場機制 | 筆數 | Net | Avg P/L | 角色 |
|---------|-----|-----|---------|------|
| TimeStop (2hr) | 23 | **+4,375,200** (100% WR) | +190,226 | 🎯 全部 alpha |
| GoldenCross | 3 | +175,200 (100% WR) | +58,400 | 輔助 |
| TailFlat (v1.3) | 1 | +42,800 (100% WR) | +42,800 | 收盤前護欄 |
| BE_Trail ×2 (v1.4 延後) | 3 | +1,200 | — | 晚期守門員 |
| ML_Exit (Rule #17) | 1 | -28,000 | -28,000 | 首次參戰 |
| QuickStop ×2 | 81 | **-2,559,600** | -31,600 | 🛡️ 控損成本 |
