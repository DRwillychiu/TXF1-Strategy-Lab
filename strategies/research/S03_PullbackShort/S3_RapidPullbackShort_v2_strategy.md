...
| 日期 | 決策 | 來源 |
|------|------|------|
| 2026-06-20 | **v2.0.2 Secular Bull Filter** (Section 2b): 用戶 audit 15-trade 歷史發現 4 筆「不該進場卻進場」 trade 在 2022 trend bear / 2025 weak rally，累積虧 -32.6k。原 Tier 1 A (60M MA20>MA60) 只看短中期 MA 結構，被 2022 短期反彈 / 2025 弱多頭 close 站上短中期 MA 而誤過。**新 Section 2b 加 3 條件 AND**：(1) Close > 60M MA_Fast (~60day 季線) (2) Close > 60M MA_Slow (~200day 年線) (3) MA_Fast > MA_Slow (結構多頭)。Mirror L1 P6 Weekly filter，downscale 到 60M scale。AND 邏輯（非 L1 OR）因 S3 是 counter-trend，需嚴格確認真多頭才做空。新 inputs：Enable_Secular_Bull_Filter (True default) / H60_SecularMA_Fast (1140) / H60_SecularMA_Slow (3800)。預估擋 4 筆爛 trade 救回 +32.6k，2026 H1 +274k 完全保留。verify 99 → 111 PASS。 | 本 session（用戶 audit 結果 + L1 P6 lesson） |
