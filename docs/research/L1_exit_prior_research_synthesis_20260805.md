...
| **X4 Breakout Quality Filter（V3.2）** | 用 Data4(1M) 對每個突破訊號打分（Momentum / Flirtation / Ascending Lows），夜盤需 score=3、日盤 ≥2 — **進場端，非出場端，但示範了跨時框脆弱性** | **2026-07-25 KILLED** | V3.1 MC12：445 筆 / +1,772,600 / PF 1.359 / MDD −476,600；V3.2 MC12：371 筆 / **+1,536,800** / PF 1.323 → **−235,800（−13.3%）**；同期 **Python projection：283 筆 / +3,464,800 / PF 2.614**（≈ MC12 實測的 2.25 倍） `[MC12 兩欄 + 離線-py 一欄，文件自帶三欄對照]` | 「Flirtation cliff-edge」：Breakout_Level 在 MC12 原生 45M bar 與 Python `resample('45min')` 產生的 bar 邊界不同 →「This is structural and unfixable — the two platforms will never produce identical 45M bar boundaries.」 | `strategies/research/L1_TrendLong/L1_v3.2/L1_v3.2_X4_FINAL_VERDICT.md:3,5,9-19,23-30,37-40,49-50,64-69,83-96` |
