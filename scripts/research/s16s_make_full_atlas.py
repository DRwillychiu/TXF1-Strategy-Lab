...
NOTCODED = [
 ...
 ('P29', '擴散三角／喇叭形', 'Broadening Formation', '中性', '★ 邏輯規劃完成 2026-08-25（S16S_P29_logic_spec）—— 樞紐純分形、對稱 3+3、S1 雙尺度、E1 外推、收盤單根突破，自由參數 0。待程式碼化', 'line',
...
CHD = {
 ...
 'P29': '高點越來越高、低點越來越低，波動整段擴大。實測 6,238 根（1.480%），中點漂移分三向：上升 47.1% / 下降 50.4% / 水平 2.5%',
 'P30': '先擴散再收斂，形狀像一顆鑽石',
 'P31': '一段高點被兩側缺口孤立成一座島',
 'P32': '急漲之後立刻急跌，沒有任何盤整',
 'P49': '擴散型態出現在一段上漲之後',
