...
"""
    ...
    TOP = ('<div class="wrap"><header class="top">'
           '<div class="eyebrow">S16_S 圖形型態 · 鑽石 · 結案 2026-08-28</div>'
           '<h1>鑽石型態 P30 · P61</h1>'
           ...
           '<span><b>260861</b>已上線並驗收</span>'
           '</div>'
           '<p class="warn"><b>裁示 I1：結案不再研究，但已完整程式碼化並上圖。</b>'
           'Build 260861 在 MC12 驗收通過（<code>DIA TALLY P30=0 P61=1</code>）。'
           '第三節是本頁的核心 —— <b>完整鑽石八年只出現一次</b>。</p>'
           '</header>')
    ...
    P5 = ('<section class="panel"><div class="ph2">'
          '<h2>七、裁示結果與實作</h2>'
          '<span class="tag">2026-08-28 已定案</span></div>'
          '<div class="rule">'
          '<div class="ro"><span class="tag rec">I1</span><p>'
          '<b>結案不再研究，但完整程式碼化並上圖。</b>'
          '與裁示 B1 對 P53／P54 的處理相同。用戶原話：'
          '「鑽石型態還是必須要保留，因為未來肯定會出現這樣的形態。」</p></div>'
          '<div class="ro"><span class="tag rec">OK</span><p>'
          '<b>Build 260861 已上線並在 MC12 驗收通過</b> —— '
          '<code>DIA TALLY  P30=0  P61=1</code>，與基準逐字相同。'
          '2025-09-08 那個實例在圖上畫出四條邊圍成的菱形。</p></div>'
          '</div>'
          '<p class="cap" style="margin-top:10px"><b>實作要點</b></p>'
          '<table><thead><tr><th>項目</th><th style="text-align:left">內容</th>'
          '</tr></thead><tbody>'
          '<tr><td>架構</td><td style="text-align:left">'
          '<b>獨立的十樞紐鏈</b>。既有六樞紐鏈一行沒動 —— 那條鏈 08-28 在 MC12 '
          '11 個量全中，加寬會移動 P29 讀取的每一個索引</td></tr>'
          '<tr><td>四條邊</td><td style="text-align:left">'
          '畫成 TL 物件（Magenta）。<b>只塗色的鑽石看不出是鑽石，邊才是形狀本身</b>；'
          '八年一個，四個物件是免費的</td></tr>'
          '<tr><td>本體塗色</td><td style="text-align:left">'
          'P30 DarkMagenta ／ P61 DarkBlue。'
          '<b>鑽石的塗色優先於它內含的 P29</b>，否則稀有形狀會被自己的組成部分蓋住</td></tr>'
          '<tr><td>標籤</td><td style="text-align:left">'
          '<code>P61 #1</code>，用<b>邊的顏色</b>不是本體顏色 —— '
          '260860 用 DarkBlue 在黑底上讀不到，260861 修正</td></tr>'
          '<tr><td>MaxBarsBack</td><td style="text-align:left">'
          '最大跨度 55 根，形成期單獨<b>從未</b>超過 99；'
          '形成＋有效期超過 99 的只有 4/9,592 ＝ 0.04%</td></tr>'
          '</tbody></table>'
          '<p class="warn"><b>驗證</b>：ASCII 73/73、語意 <b>0 FAIL 0 WARN 18 PASS</b>、'
          'begin/end 102/102、陣列 22 個無越界、'
          '<b>十槽鏈移植回 Python 逐根模擬找到 1 個、P61、20250908、跨度 23 —— 全中</b>。'
          '過程中驗證器抓到 6 個死變數（四條邊用日期時間不是根號），已刪。</p>'
          '</section>')
