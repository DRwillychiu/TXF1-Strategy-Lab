...
"""
    ...
    P6 = ('<section class="panel"><div class="ph2"><h2>六、裁示與下一步</h2>'
          '<span class="tag">2026-08-28</span></div>'
          '<table><thead><tr><th>編號</th><th style="text-align:left">裁示</th>'
          '</tr></thead><tbody>'
          '<tr><td>X3</td><td style="text-align:left">'
          '<b>樞紐視窗做成指標 input（預設 1）</b>，在圖上切換看過再決定基準</td></tr>'
          '<tr><td>—</td><td style="text-align:left">'
          '<b>操作週期永遠是 5 分 K</b>（見第四節）</td></tr>'
          '<tr><td>—</td><td style="text-align:left">'
          '<b>只挑空方型態，避開多方</b>（見第五節）</td></tr>'
          '<tr><td>17／18</td><td style="text-align:left">'
          '<b>區間裝置與尺度已寫入檢查表</b>（'
          '<code>.claude/skills/pattern-definition-checklist</code>，15 條 → 18 條）</td></tr>'
          '<tr><td>—</td><td style="text-align:left">'
          '<b>編碼等樞紐討論完成後一起做</b>，避免尺度一改就重寫</td></tr>'
          '</tbody></table>'
          '<p class="warn"><b>下一步：一次編碼。</b>'
          '內容為 <code>Pivot_Window</code> input ＋ 三個空方型態'
          '（P18／P68／P57）進指標。'
          '既有六樞紐鏈與鑽石十樞紐鏈<b>都不必動</b> —— '
          'P68 用鏈上最後 3 個樞紐、P18／P57 用最後 5 個。</p></section>')
