...
PAT = [
 ...
 ('P18', '三重頂', 'Triple Top', '空', 'H L H L H',
  ...
  [(0, 4, 'tlu solid')],
  ['PH1 = PH2 = PH3　<b>完全相等</b>', 'PL1、PL2 不設條件'],
  '43', '5.6', 8, [12, 8, 5, 6, 6, 5, 1, 0],
  ('43', '0.49', '87.93x', '0.0005', True),
  '<b>★ 通過，而且倍率是全組最高。</b>'
  '打三次同一個精確價位，鄰近打散下期望只有 <b>0.49</b> 個，實際 43 個。'
  '<b>但 2026 出現 0 次</b> —— 不能用的理由是它已經不出現，不是檢定不過。'
  '見第四節的衰減定律。'),

 ('P23', '三重底', 'Triple Bottom', '多', 'L H L H L',
  [('L', 22), ('H', 68), ('L', 22), ('H', 74), ('L', 22)],
  [(0, 4, 'tld solid')],
  ['PL1 = PL2 = PL3　<b>完全相等</b>', 'PH1、PH2 不設條件'],
  '33', '4.3', 7, [10, 4, 3, 4, 7, 3, 1, 1],
  ('33', '0.49', '66.73x', '0.0005', True),
  '鏡像，同樣通過（66.73x）。<b>鏡像也通過，代表沒有方向性</b> —— '
  '測到的是價位被重訪，不是頂或底。'),
 ...
 ('P21', '上升通道', 'Ascending Channel', '多', '6 個交替樞紐（H 起或 L 起皆可）',
  ...
  ['PH1 &lt; PH2 &lt; PH3', 'PL1 &lt; PL2 &lt; PL3',
   ...
   '(PH3 − PH1) = (PL3 − PL1)　<b>兩條線完全平行</b>'],
  '140', '18.3', 12, [23, 27, 14, 12, 20, 17, 16, 11],
  ('140', '49.6', '2.82x', '0.0005', True),
  '<b>★ 通過。</b>母集（高遞增＋低遞增）3,729 個，'
  '其中兩條線升幅<b>完全相等</b>的有 140 個，鄰近打散期望 49.6。'
  '下降通道對照 2.34x <b>也通過</b>，所以同樣沒有方向性。'
  '<b>逐年無掛零</b>，是全組唯一分布穩定的。'),
...
"""
    ...
    P5 = ('<section class="panel"><div class="ph2">'
          ...
          '<h3>P15／P16 結案<em>建議</em></h3>'
          '<p>形狀對照 0.958:1 不含資訊；零參數收緊（PH3&lt;PH1）在對照組是同樣比例；'
          '嚴格版八年 14 個且 2024-2026 全掛零。</p></div></div>'
          '<div class="st"><div class="n">L</div><div class="bd2">'
          '<h3>P18／P23 —— 通過但已滅絕<em>要你決定</em></h3>'
          '<p>87.93x／66.73x 是全組最強，<b>但 2026 出現 0 次</b>，'
          '且衰減是算術性的、不會回來。'
          '選項：<b>L1</b> 編碼上圖如鑽石（承認罕見但保留）／<b>L2</b> 直接結案。</p>'
          '</div></div>'
          '<div class="st"><div class="n">M</div><div class="bd2">'
          '<h3>P68／P57／P21 —— 通過但無方向<em>要你決定</em></h3>'
          '<p>三個都通過，鏡像也都通過。'
          '<b>M1</b> 比照裁示 A1 當屬性（不是濾網）／<b>M2</b> 只編碼上圖／'
          '<b>M3</b> 一併結案。<b>P21 是唯一逐年無掛零的</b>。</p></div></div>'
          '<div class="st"><div class="n">N</div><div class="bd2">'
          '<h3>「價位重訪」要不要獨立立項<em>新問題</em></h3>'
          '<p>2.3x ~ 87.9x 是本專案目前<b>最強的統計效果</b>，'
          '但它是價位行為、不是型態。若要用，應以「<b>價位重訪</b>」立項，'
