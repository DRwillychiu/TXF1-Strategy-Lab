...
LOGIC = {
 ...
 'P55': ('L H L H L H L', [
   ...
   '所以它<b>在範疇內、而且零參數</b>，母體 2,977、跨度中位 22 根。'
 ...
 'P60': ('L H L H L H', [
   ...
   '<br>問題是：<b>排名條件只排掉 1,758 中的 2 個（0.11%）</b>。'
   '因為 P24 的「旗面留在旗桿區間內」已經逼得旗桿必然最大。'
   '<b>P60 ≡ P24，不是另一個型態</b> —— '
   '而 P24 昨天已經化約成降降格的 18.4%。'),
}
...
P4 = ('<section class="panel"><div class="ph2">'
      ...
      '問題是實測 —— <b>排名條件只排掉 1,758 中的 2 個，0.11%</b>。'
      '因為 P24 的「旗面留在旗桿區間內」已經逼得旗桿必然最大。'
