...
|------|------|---------|------|------|---------|--------|---------|---------|---------|-------|------|--------|
| B01 | S1 | NightMomentum | ★純做多 | 15M | +1,997,000 | 1.448 | -278,800 | ~12.4 | ✅ PASS@1M | 3/4 | P1~P3完成, PASS@1M/FAIL@500k | 🥇 高 |
...
|------|--------|-------|-------|--------|------|---------|------|
| S1 NightMomentum | ✅ | ✅ v2.1 PASS | ❌@500k/✅@1M | — | ✅ PASS@1M | 2026-06-07 | 最低帳戶1M, 95%MDD=27.2% |
