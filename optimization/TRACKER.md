...
|------|------|---------|------|------|---------|--------|---------|---------|---------|-------|------|--------|
| B01 | S1 | NightMomentum | ★純做多 | 15M | +1,597,400 | 1.292 | -318,000 | ~7.4 | 🟡 進行中 | 2/4 | v2.0 ATR GA完成, 待MC12 WFA | 🥇 高 |
...
|------|--------|-------|-------|--------|------|---------|------|
| S1 NightMomentum | ✅ | ❌ 待MC12 | — | — | 🟡 進行中 | — | v2.0 ATR GA完成, 待MC12 15M WFA |
