...
|------|------|---------|------|------|---------|--------|---------|---------|---------|-------|------|--------|
| B01 | S1 | NightMomentum | ★純做多 | 15M | +1,997,000 | 1.448 | -278,800 | ~12.4 | 🟡 P2通過 | 3/4 | v2.1 WFE=62.5% ✅, 待MC | 🥇 高 |
...
|------|--------|-------|-------|--------|------|---------|------|
| S1 NightMomentum | ✅ | ✅ v2.1 PASS | ⏸️ 待執行 | — | 🟡 進行中 | 2026-06-07 | v2.1 WFE=62.5%, OOS+1,939k |
