...
> 最後更新：2026-06-07 (S1 MC12 15M WFA P2 完成)
...
|------|------|---------|------|------|---------|--------|---------|---------|---------|-------|------|--------|
| B01 | S1 | NightMomentum | ★純做多 | 15M | +1,597,400 | 1.292 | -318,000 | ~7.4 | 🟡 v2.1重跑 | 2/4 | v2.1加VolFilter, 待MC12 GA+WFA | 🥇 高 |
...
|------|---------|---------|--------|------|--------|---------|---------|
| S1 | 24 | 6 | 8 | 50%(名義)/33.3%(有效) | 累計+510,600 | +510,600 | ⚠️ 不通過(有效WFE<50%, MDD爆表) |
| S2 | 24 | 6 | — | — | — | — | — |
| S3 | 24 | 6 | — | — | — | — | — |
| S4 | 24 | 6 | — | — | — | — | — |
| S5 | 24 | 6 | — | — | — | — | — |
...
|------|--------|-------|-------|--------|------|---------|------|
| S1 NightMomentum | ✅ | ⚠️ 不通過 | — | — | ⚠️ P2不通過 | 2026-06-07 | WFE=33.3%(有效), 連虧4窗, MDD 65% |
